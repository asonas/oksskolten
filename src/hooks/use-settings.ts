...
import { useArticleSort, type ArticleSort } from './use-article-sort'
...
interface Prefs {
  ...
  'reading.article_sort': string | null
...
export function useSettings() {
  ...
  const { articleSort, setArticleSort } = useArticleSort()
  ...
  const articleSortRef = useRef(articleSort)
  articleSortRef.current = articleSort
  ...
  useEffect(() => {
    ...
    const hydrationMap: Array<{
      ...
      { key: 'reading.category_unread_only', setter: setCategoryUnreadOnly, backfillRef: categoryUnreadOnlyRef,
        validate: v => v === 'on' || v === 'off' },
      { key: 'reading.article_sort', setter: setArticleSort, backfillRef: articleSortRef,
        validate: v => v === 'desc' || v === 'asc' },
  ...
  }, [prefs, setTheme, setDateMode, setAutoMarkRead, setShowUnreadIndicator, setInternalLinks, setShowThumbnails, setShowFeedActivity, setChatPosition, setArticleOpenMode, setCategoryUnreadOnly, setArticleSort, setLayout, setMascot, setHighlightTheme, setArticleFont, setKeyboardNavigation, setKeybindings])
  ...
  const {
    ...
    return {
      ...
      syncedSetArticleSort: make<ArticleSort>('reading.article_sort', setArticleSort),
  ...
  }, [setDateMode, setAutoMarkRead, setShowUnreadIndicator, setInternalLinks, setShowThumbnails, setShowFeedActivity, setChatPosition, setArticleOpenMode, setCategoryUnreadOnly, setArticleSort, setLayout, setArticleFont, setMascot])
  ...
  return {
    ...
    articleSort,
    setArticleSort: syncedSetArticleSort,
    layout,
