...
const dict = {
  ...
  'settings.viewerDesc': { ja: '登録済みのフィードの名前変更・カテゴリ変更・削除ができます', en: 'Rename, recategorize, or delete your subscribed feeds', zh: '重命名、重新分类或删除已订阅的订阅源'},
  'settings.feedFilterPlaceholder': { ja: 'フィードを検索', en: 'Filter feeds', zh: '筛选订阅源'},
  'settings.feedCount': { ja: '${count} 件のフィード', en: '${count} feeds', zh: '${count} 个订阅源'},
  'settings.noFeedsFound': { ja: '該当するフィードがありません', en: 'No feeds match your filter', zh: '没有符合筛选条件的订阅源'},
