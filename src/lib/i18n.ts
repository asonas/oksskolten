...
const dict = {
  ...
  'settings.viewerDesc': { ja: '登録済みのフィードの名前変更・カテゴリ変更・削除ができます', en: 'Rename, recategorize, or delete your subscribed feeds' },
  'settings.feedFilterPlaceholder': { ja: 'フィードを検索', en: 'Filter feeds' },
  'settings.feedCount': { ja: '${count} 件のフィード', en: '${count} feeds' },
  'settings.noFeedsFound': { ja: '該当するフィードがありません', en: 'No feeds match your filter' },
  'settings.feedDisabled': { ja: '無効', en: 'Disabled' },
